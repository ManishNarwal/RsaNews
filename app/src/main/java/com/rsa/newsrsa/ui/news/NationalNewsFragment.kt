...
import com.rsa.newsrsa.databinding.FragmentNationalNewsBinding
...
class NationalNewsFragment : Fragment() {
    private lateinit var binding : FragmentNationalNewsBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_national_news,container,false)
        binding.model = model
