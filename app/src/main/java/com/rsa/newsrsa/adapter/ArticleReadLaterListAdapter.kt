...
class ArticleReadLaterListAdapter @Inject constructor(
    private val newsLocalRepository: NewsLocalRepository,
    private val resourcesProvider: ResourcesProvider,
    private val findNavController: NavController
) : PagingDataAdapter<Article, ArticleReadLaterListAdapter.ArticleViewHolder>(ARTICLE_COMPARATOR) {
    ...
    private fun showData(article: Article) {
        binding.imgReadLater.visibility = View.GONE
        ...
        binding.rootView.setOnClickListener {
            val action = NewsReadLaterFragmentDirections.actionNewsReadLaterFragmentToReadmoreFragment(article.id)
